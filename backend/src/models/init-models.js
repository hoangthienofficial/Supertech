...
export default function initModels(sequelize) {
  ...
  chat.belongsTo(chatRoom, { as: "room", foreignKey: "room_id" });
  chatRoom.hasMany(chat, { as: "chats", foreignKey: "room_id" });
  ...
  product_quality.belongsTo(product_colors, {
    as: "color",
    foreignKey: "color_id",
  });
  product_colors.hasMany(product_quality, {
  ...
  product_quality.belongsTo(product_storage, {
    as: "storage",
    foreignKey: "storage_id",
  });
  product_storage.hasMany(product_quality, {
    as: "product_qualities",
    foreignKey: "storage_id",
  });
  ...
  product_quality.belongsTo(products, {
    as: "product",
    foreignKey: "product_id",
  });
  products.hasMany(product_quality, {
    as: "product_qualities",
    foreignKey: "product_id",
  });
