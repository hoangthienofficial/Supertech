...
export const IMG_BACKEND =
  "https://res.cloudinary.com/dcvkmhlhw/image/upload/v1730647279/";
export const IMG_BACKEND_USER =
  "https://res.cloudinary.com/dcvkmhlhw/image/upload/v1732655979/User";
export const IMG_BACKEND_SETTING =
  "https://res.cloudinary.com/dcvkmhlhw/image/upload/v1733480370/";
